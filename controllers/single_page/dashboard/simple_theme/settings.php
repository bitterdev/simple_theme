...
namespace Concrete\Package\SimpleTheme\Controller\SinglePage\Dashboard\SimpleTheme;
    ...
    public function view()
    {
        if ($this->request->getMethod() === "POST") {
            ...
            if ($this->formValidator->test()) {
                $this->config->save("simple_theme.regular_logo_file_id", (int)$this->request->request->get("regularLogoFileId"));
        ...
        $this->set("regularLogoFileId", (int)$this->config->get("simple_theme.regular_logo_file_id"));
    }
}